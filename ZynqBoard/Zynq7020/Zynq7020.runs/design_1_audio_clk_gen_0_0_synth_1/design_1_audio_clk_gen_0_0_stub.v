...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(nReset, audioClk256, sysClk, audioClk)
/* synthesis syn_black_box black_box_pad_pin="nReset,audioClk256,sysClk,audioClk" */;
  input nReset;
  input audioClk256;
  input sysClk;
  output audioClk;
