...
#define _3C_PDR2_DEFAULT        (0x3CU) /* PDR2 default value */
#define _08_PDR3_DEFAULT        (0x08U) /* PDR3 default value */
#define _CF_PDR5_DEFAULT        (0xCFU) /* PDR5 default value */
#define _80_PDRA_DEFAULT        (0x80U) /* PDRA default value */
#define _03_PDRC_DEFAULT        (0x03U) /* PDRC default value */
#define _F8_PDRD_DEFAULT        (0xF8U) /* PDRD default value */
#define _C0_PDRE_DEFAULT        (0xC0U) /* PDRE default value */
#define _F0_PDRH_DEFAULT        (0xF0U) /* PDRH default value */
#define _3D_PDRJ_DEFAULT        (0x3DU) /* PDRJ default value */
